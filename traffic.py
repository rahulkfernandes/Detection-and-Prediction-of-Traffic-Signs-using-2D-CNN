...
dataGen= tf.keras.preprocessing.image.ImageDataGenerator(width_shift_range=0.1,   # 0.1 = 10%     IF MORE THAN 1 E.G 10 THEN IT REFFERS TO NO. OF  PIXELS EG 10 PIXELS
...
# TO DISPLAY AUGMENTED AND PROCCESSED IMAGE SAMPLES
...
model.save("/home/rahulkf/Projects/Traffic/model/traffic_model.h5") 
